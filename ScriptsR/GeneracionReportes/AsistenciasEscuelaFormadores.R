...
nombres_columnas <- c("Nombre","Cedula","Organizacion","Sep s4",paste("Oct s",1:3,sep = ""),paste("Nov s",1:2,sep = ""))
...
nombres_columnas <- c("Nombre","Cedula","Organizacion",paste("s",1:6, sep = ""))
colnames(AsistenciasNodos) <- nombres_columnas
